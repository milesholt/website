...
var showcase = $('#showcase'),
	...
	/*
	<div class="row no-marg-bot col-fill-height" data-rowid="1">
                              <div class="col s12 m6 l4 grid-slide" data-slide="0">
                              		<div class="grid-title"><h3>Voila</h3></div>
                              		<img src="assets/images/projects/voila/1.jpg" width="100%">
                              </div>
                              <div class="col s12 m6 l4 grid-slide" data-slide="2">
                                   <div class="grid-title"><h3>Elisa &amp; The Cottontail Bird</h3></div>
                              	   <img src="assets/images/projects/elisa/1.jpg" width="100%">
                              </div>
                              <div class="col s12 m6 l4 grid-slide" data-slide="3">
                               	   <div class="grid-title"><h3>Pro2Pac</h3></div>
                              	   <img src="assets/images/projects/pro2pac/5.jpg" width="100%">
                              </div>
                          </div>
          */
...
$(window).on('load', function(){
	...
	menu_toggle.click(function(){
		...
		if(isMobile() === false){
			console.log('toggle menu doresize');
